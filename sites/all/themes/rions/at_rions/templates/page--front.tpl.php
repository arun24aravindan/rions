  ...
  <div id="page" class="container <?php print $classes; ?>">
    ...
    <?php if ($secondary_navigation): print $secondary_navigation; endif; ?>
      ...
      <?php print render($page['header']); ?>
			...
			<!-- !Home Content Region -->
    <?php if ($page['home_content'] || $attribution): ?>
      <div id="home-content">
        <?php print render($page['home_content']); ?>
        <?php print $attribution; ?>
		<!-- !Home Content Slide Region -->
    <?php if ($page['home_content_slide'] || $attribution): ?>
      <div id="home-content-slide">
        <?php print render($page['home_content_slide']); ?>
        <?php print $attribution; ?>
      </div>
    <?php endif; ?>
      </div>
